...
Som bekant så implementerade jag bara dekompressionsversionen av
DEFLATE algoritmen, för att jag upptäckte snabbt att det skulle bli
mycket svårt att implementera kompressionversionen. Genom att bara
implementera dekompressionsversionen kunde jag analysera färgdatan i
PNG-bilder, vilka använder DEFLATE för att komprimera färgdatan.

Men idag har äntligen börjat att förstå hur jag ska gå till väga för
att implementera kompressionsversionen. Så idag påbörjade jag arbetet
på detta. Jag kommer att fortsätta att beskriva PNG formatet
skriftligt när jag väl är färdig med att implementera DEFLATE.

\dayheading{6}{2}{2012}

Jobbade vidare med arbetet som jag påbörjade igår. DEFLATE algoritmen
kommer förmodligen att ta ett bra tag att implementera, för den har
rätt så många delsteg.
...
Jobbat vidare. Den algoritm som jag för tillfället jobbar på att
implementera heter Huffmankodning. Det är en delalgorithm i DEFLATE
och snart bör jag vara klar med att implementera den. Skrev även lite
om algoritmen i den skriftliga delen av arbetet.

\dayheading{10}{2}{2012}

Jobbat vidare. Nu är jag nästan färdig med att implementera
Huffmankodning. Om allt går väl bör jag bli klar i morgon.

\dayheading{11}{2}{2012}

Blev idag färdig med att implementera Huffmankodning.

Den andra delalgoritmen i DEFLATE heter LZ77. Den hann jag börja på
idag, och eftersom att den är så simpel så har jag redan hunnit
implementera en majoritet den algoritmen.

\dayheading{12}{2}{2012}

Min implementation av LZ77 är nu också klar. Nu återstår det bara att
kombinera ihop LZ77 och Huffmankodning till den slutgiltiga DEFLATE
algoritmen, vilket i värsta fall kan ta ett flertal några dagar, det
beror fullständigt på hur många buggar som jag skapar under kodandet
och därför blir tvungen att fixa.

\dayheading{13}{2}{2012}

Jag upptäckte en bugg i programmet jag skrev igår som orsakade att
programmets kompression på filer blev, rent ut sagt, för jävlig. Det
var rätt så svårt att fixa problemet och att jag spenderade hela dagen
på att lösa det.

\dayheading{14}{2}{2012}

Påbörjade idag min implementation av DEFLATE. LZ77-delen av algoritmen
har jag idag lyckats att implementera. Nu återstår bara
Huffmankodning-delen.

\dayheading{14}{2}{2012}

Gjorde idag färdigt min implementation av DEFLATE. Jag hann även att
fullständigt beskriva LZ77 algoritmen idag kortfattat. Jag fortsatte
även med att beskriva vissa delar av PNG formatet som jag ännu inte
hunnit att beskriva.

\dayheading{24}{2}{2012}

Är nu även färdig med att beskriva PNG formatet. Det enda som återstår
nu är att göra färdigt min implementation av DEFLATE kompression, och
att sedan skriftligt sammanfatta algoritmen. Efter det är jag rätt så
mycket färdig med projektarbetet.

\dayheading{25}{2}{2012}

Blev idag färdig med min implementering av DEFLATE kompression.

\dayheading{27}{2}{2012}

Har börjat att beskriva DEFLATE algoritmen skriftligt idag.

\dayheading{28}{2}{2012}

Blev idag färdig med att beskriva de enklare bitarna av DEFLATE
algoritmen. Vad som återstår är att nu beskriva de riktigt knepiga
bitarna av den, vilket kan ta en del tid med tanke på att jag knappt
själv vet hur de fungerar.

\dayheading{29}{2}{2012}

Idag renskrev jag allt som jag hade skrivit om DEFLATE.

\dayheading{4}{3}{2012}

Har under de senaste två dagarna läst igenom hela arbetet(den
skriftliga delen) och rättat ett flertal fel som jag inte upptäckt
under de tidigare renskrivningarna.

\dayheading{10}{3}{2012}

Blev idag \textit{äntligen} färdig med kapitlet om DEFLATE. Skrev även
ett utkast till avslutningen idag, där jag kort sammanfattar vad jag
har lärt mig av projektet, och vilka slutsatser som kan dras.

\dayheading{13}{3}{2012}

Har under de senaste dagarna fördjupat mig lite inom
informationteori. Jag har specialiserat mig att på att förstå vissa
bevis inom området som bevisar att en perfekt kompressionalgoritm, en
algoritm som kan komprimera all data, är omöjlig. För att sammanfatta
mina upptäckter har jag därför börjat att jobba på ett nytt kapitel i
arbetet där jag på ett så lättbegripligt sätt som möjligt sammanfattar
de olika bevisen jag har hittat. Allt annat i projektarbetet är jag
rätt så mycket klar med, så detta har gott om tid med att slutföra.
