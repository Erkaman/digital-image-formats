...
In this chapter we'll discuss the first compression algorithm if this
book. First we will need to introduce you to some terminology related
to data compression, though, which is what the discussion subject in this
