...
creating at the time. The two constants $RawPacket$ and
...
packet continues by incrementing the $length$ variable and setting the
...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    ...
    \linecomment{(The indexes of arrays are zero-based.)}
