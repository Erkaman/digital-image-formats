...
\item[ASCII] A very common text encoding that will be used a lot in
  ...
  linefeed, LF. Unix based operating systems; like Linux, Mac OS X and Xenix;
  simply uses a line feed, LF, to represent newlines.\cite{robbins:_common_newline,noria:_under_newlin_oreilly,editor:_end_line_story_rfc,tancig01:_apart_no_more_newline,corporation08:_creat_telep_applic_both_window_linux}.
