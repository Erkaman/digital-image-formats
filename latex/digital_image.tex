...
other color can be represented(?) \todo{no they cannot, there are
  limitations}. Like it is represented in color table \ref{tab:color-examples}
...
% When we start talking about alpha ch
