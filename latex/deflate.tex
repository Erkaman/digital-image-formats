...
table~\ref{tab:fixed-length-litteral-huffman}. Using this table, the
end code, 256, will be represented by the 7-bit Huffman Code
...
data. So it is to us incomprehensible why these two codes are given
assigned Huffman codes. But since they will never occur in the data we
...
table~\ref{tab:huffman-codes-sorted} are shown. We will now show that
