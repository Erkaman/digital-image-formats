...
Both of these two computed numbers are known as
\textit{checksums}\index{checksum}. A checksum is simply a value
calculated from a sequence of numerical data that is used to verify
that the data is error free. I was unfortunately unable to find a
strict definition of a checksum, but do note that summings do not
necessarily have to occur for a number to be classified as a
checksum.
