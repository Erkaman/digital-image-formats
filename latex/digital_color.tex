...
\begin{refsection}
  ...
  wavelengths\index{wavelength}. They are also called light
  waves\index{light waves} \cite{neider93:_openg_progr_guide}
  ...
  An 8-bit number has, as you should be familiar with, only $256$
  possible values. If we assign an 8-bit number to each color channel,
  the color's total size will be 24-bits. This way of representing
  color is called 24-bit color\index{24-bit color}. You can also say
  that its color depth\index{color depth} is 24 bits.
